...
const JobDetails = () => {
  ...
  return (
    <div data-aos="fade-up" data-aos-delay="200" className='w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8 overflow-x-hidden'>
      <div className='flex flex-col items-center justify-center text-center gap-4 sm:gap-5 mt-5'>
        <h1 className='font-semibold text-2xl sm:text-3xl md:text-4xl text-[var(--heading)]'>Job Listing</h1>
        <div className='topOptions flex flex-row flex-wrap gap-3 sm:gap-4 md:gap-6 justify-center items-center text-base sm:text-lg md:text-xl text-[var(--heading)] pb-3'>
          <h2 className='border-b-2 border-transparent transition hover:border-b-2 hover:border-green-500 hover:transition hover:delay-200 cursor-pointer px-2 py-1' onClick={() => setActiveTab("Featured")}>Featured</h2>
          <h2 className='border-b-2 border-transparent transition hover:border-b-2 hover:border-green-500 hover:transition hover:delay-200 cursor-pointer px-2 py-1' onClick={() => setActiveTab("Full Time")}>Full Time</h2>
          <h2 className='border-b-2 border-transparent transition hover:border-b-2 hover:border-green-500 hover:transition hover:delay-200 cursor-pointer px-2 py-1' onClick={() => setActiveTab("Part Time")}>Part Time</h2>
